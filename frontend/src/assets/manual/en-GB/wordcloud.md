...
The wordcloud will count the frequencies of words in search results. We use a list of common stopwords to exclude, if this is supported for the field. After this, the frequency of the remaining words in the text field is counted.
