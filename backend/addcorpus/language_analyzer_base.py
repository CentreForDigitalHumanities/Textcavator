'''
Defines the base class for language_analyzers module.
'''
...
class LanguageAnalyzer(ABC):
    ...
    stemmers from Elasticsearch. You may need to override these methods, usually because
    the language is not supported or uses a different name.
    '''
